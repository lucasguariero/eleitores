...
function Aniversarios({ navigate }: { navigate: Navigate }) {
  ...
  return <>
    <PageHeader eyebrow="Relacionamento" title="Aniversários" description="Datas de candidatos, municípios e padroeiras — e a presença que cada uma pode gerar." actions={<button className="secondary-button"><Download size={16} /> Exportar PDF</button>} />
